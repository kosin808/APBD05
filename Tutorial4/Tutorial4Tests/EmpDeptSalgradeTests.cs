...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Any(d => d.Loc == "CHICAGO" && d.DeptNo == e.DeptNo)).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts,e=>e.DeptNo,d=>d.DeptNo, (e, d) => new{d.DName,e.EName}); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Select(e => new {e.EName, grades.Single(g => e.Sal >= g.Losal && e.Sal <= g.Hisal).Grade});
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e=>e.DeptNo).Select(e=>new {DeptNo = e.Key,AvgSal =e.Average(s=>s.Sal) }); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(d => d.DeptNo == e.DeptNo).Average(s => s.Sal)).Select(e => e.EName);
