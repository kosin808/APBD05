...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps,e=>e.Mgr,d=>d.EmpNo, (e,d)=>new {Employee=e.EName,Manager=d.EName});
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts,e=>e.DeptNo,d=>d.DeptNo,(e,d)=>new {e,d}).Select(g=> new {g.e.EName,g.d.DName,grades.Single(s => g.e.Sal >= s.Losal && g.e.Sal <= s.Hisal).Grade}); 
